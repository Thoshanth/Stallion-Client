...
import StallionClassicHero from '@/components/public/StallionClassicHero';
import StallionClassicAbout from '@/components/public/StallionClassicAbout';
import FAQSection from '@/components/public/FAQSection';
import EventsContactSection from '@/components/public/EventsContactSection';

export const metadata = {
  title: 'Stallion Classic | Stallion Xtreme Fitness',
  description: "Hyderabad's premier elite physique competition.",
};
...
export default function StallionClassicPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      <Navbar />
      <StallionClassicHero />
      <StallionClassicAbout />

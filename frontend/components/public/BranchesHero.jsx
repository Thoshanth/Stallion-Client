  ...
  return (
    <section ref={heroRef} className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-4 w-full max-w-5xl mx-auto mt-16">
        ...
        >
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-akira text-white mb-6 uppercase tracking-wider leading-tight">
            FIND YOUR NEAREST <br className="hidden md:block" /> IRON TEMPLE
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/events" className="w-full sm:w-auto px-8 py-4 bg-transparent border-2 border-primary text-primary font-akira text-sm md:text-base hover:bg-primary/10 transition-all duration-300 uppercase tracking-wider text-center">
              Explore Events
            </Link>
          </div>
        </div>

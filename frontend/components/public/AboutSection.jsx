...
const AboutSection = ({ hideTitle = false }) => {
          ...
          <div
            ...
            <div className="flex flex-col relative">
              ...
              <div className="w-full">
                ...
                <h3 className="text-xl md:text-2xl font-bold font-degular mb-4 md:mb-6 text-gray-700">
                  At Stallion Xtreme Fitness, we&apos;re not just building bodies — we&apos;re building lifestyles.
                </h3>

                <p className="text-gray-800 mb-4 text-base md:text-lg font-degular leading-relaxed md:leading-loose tracking-wide">

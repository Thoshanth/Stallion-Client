...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black pt-24 pb-12">
      ...
      {/* Content */}
      <div className="container mx-auto px-4 md:px-6 z-20 text-center flex flex-col items-center">
        <div
          ...
          {/* Promotional Banner */}
          {showPromo &&
          <div className="mt-8 w-full max-w-md bg-white border border-gray-200 rounded-lg shadow-xl relative overflow-hidden animate-fade-in z-30">
              <button
